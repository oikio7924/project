       ...
       <div class="w-full rounded-lg bg-white p-5 my-4 md:md-4 lg:my-7">
           <div class="flex flex-wrap text-xs">
             <div class="flex items-center flex-shrink-0 mb-2.5">
               <label for="inspection_check">점검 후 이상 유/무:</label>
               <select name="AH_HOMEDIV_C" id="AH_HOMEDIV_C" onchange="pf_getList()"
             ...
             <div class="flex items-center flex-shrink-0 mb-2.5">
               ...
               <input name="searchBeginDate" type="date" id="searchBeginDate" value="${search.searchBeginDate}"
                 class="default_input_style input_margin_x_10px input_padding_y_4px">
             </div>
             <div class="flex items-center flex-shrink-0 mb-2.5">
               <label for="inspection_check">종료일시:</label>
               <input name="searchEndDate" type="date" id="searchEndDate" value="${search.searchEndDate}"
                 class="default_input_style input_margin_x_10px input_padding_y_4px">
             </div>
             <div class="flex items-center flex-shrink-0 mb-2.5">
               <label for="inspection_check">검색기간</label>
