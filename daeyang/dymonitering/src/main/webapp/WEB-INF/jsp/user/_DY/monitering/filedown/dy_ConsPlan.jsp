...
<div class="table_wrapper con_h">
       <table class="tbl_private_se">
           ...
           <thead>
           	...
           	<tr>
           		<th colspan="4" style="background: gray; color: white;">신고내역</th>
           	</tr>
           <tbody>
           	<tr class="tr1">
           		<th class="th_name1">신고용량</td>
           		<td><input type="text" class="txt_nor sm2 w100" name="dls_app_vol1" id="dls_app_vol1"></td>
           		<th class="th_name1">처리예정일</td>
           		<td><input type="text" class="txt_nor sm2 w100" name="dls_app_dueDate" id="dls_app_dueDate"></td>
           		<th class="alarm"></th>
           	</tr>
           	<tr>
           		<th class="th_name1">모듈</td>
           		<td><input type="text" class="txt_nor sm2 w100" name="dls_app_module" id="dls_app_module"></td>
           		<th class="th_name2">인버터</td>
           		<td><input type="text" class="txt_nor sm2 w100" name="dls_app_inverter" id="dls_app_inverter"></td>
           		<th class="alarm"></th>
           	</tr>
           	<tr>
           		<th class="th_name1">접수일</td>
           		<td><input type="date" class="txt_nor sm2 w100" name="dls_app_appDate" id="dls_app_appDate" onchange="updateDueDate('dls_app_appDate','dls_app_appPeriod')"></td>
           		<th class="th_name2">신고기간</td>
           		<td><input type="text" class="txt_nor sm2 w100" name="dls_app_appPeriod" id="dls_app_appPeriod"></td>
           	</tr>
           	<tr>
           		<th colspan="4" style="background: gray; color: white;">감리업체</th>
           	</tr>
           	<tr>
   			   	<th>감리업체명</th>
