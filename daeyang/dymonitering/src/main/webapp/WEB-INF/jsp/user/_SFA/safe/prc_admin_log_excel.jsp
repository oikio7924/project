...
String fileName = "안전관리 작성 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">안전관리 작성 리스트</th>
		</tr>
		<tr></tr>
		<tr>
			<th colspan="${colspan}" class="Subdate" style="text-align:left;">
				검색결과 : ${fn:length(resultList4)}건
			</th>
...
<table id="dt_basic">
	...
	<tbody>
		...
		<tr>
			...
			<td><a onclick = "taxpopup('${b.dbl_keyno}');" style="cursor: pointer;" id="listtable" name ="listtable" value ="${b.sa_keyno}">${b.sa_sulbi}</a></td>
			<td>${b.sa_date}</td>
			<td>${b.sa_opinion}</td>
		</tr>
	</c:forEach>
