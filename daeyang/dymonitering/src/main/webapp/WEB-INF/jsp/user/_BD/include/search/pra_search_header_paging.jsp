...
function pf_LinkPage(num){
	...
	//조회버튼 클릭 후 엑셀 다운로드 리스트 뽑 기위해 excelListData 넣어주기
	var AH_HOMEDIV_C = $('#AH_HOMEDIV_C').val()
	var searchBeginDate = $('#searchBeginDate').val()
	var searchEndDate = $('#searchEndDate').val()
	$('#AH_HOMEDIV_C_Excel').val(AH_HOMEDIV_C)
	$('#searchBeginDate_Excel').val(searchBeginDate)
	$('#searchEndDate_Excel').val(searchEndDate)
