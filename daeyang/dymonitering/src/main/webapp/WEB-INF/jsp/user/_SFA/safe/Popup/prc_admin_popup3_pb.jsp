      ...
      <div class="px-3 py-1 md:px-3 md:py-1 lg:px-5 lg:py-2 w-full rounded-lg bg-white my-4 md:md-4 lg:my-7">
        ...
        <div class="w-full rounded-lg bg-white my-4 md:md-4 lg:my-7">
          <div class="w-full">
	    	...
	    	<button type="button" onclick="print_p()" style="width:120px;" class="mx-3 text-xs font-semibold items-center w-16 py-2 border border-transparent rounded text-white bg-black flex-shrink-0 mb-2">프린트</button>
		...
		<input type="hidden" id="sa2_accpowertype" name="sa2_accpowertype" value="${list.sa2_accpowertype}">
		<input type="hidden" id="sa2_accpowertype2" name="sa2_accpowertype2" value="${list.sa2_accpowertype2}">
		<input type="hidden" id="sa2_preacctype" name="sa2_preacctype" value="${list.sa2_preacctype}">
		<input type="hidden" id="sa2_preacctype2" name="sa2_preacctype2" value="${list.sa2_preacctype2}">
    </div>
  </div>
</main>
</form:form>
...
function print_p(){
    ...
    window.onbeforeprint = function(){
        ...
        "body { font-size: 14pt; margin: 0mm; width : 285mm; height : 400mm; }" +
        "</style>";
  		document.head.innerHTML += printStyle;
        document.body.innerHTML = document.getElementById('printField').innerHTML;
    }  
