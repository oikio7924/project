            ...
            <tr class="font-bold text-black">
              ...
              <td class="px-4 py-3 text-center text-xs">
                <input type="text" data-searchindex="4"
                  class="default_input_style input_margin_x_10px input_padding_y_4px search-control search-control"
              ...
              <td class="px-4 py-3 text-center text-xs">
                <select name="status_eq" data-searchindex="7" onchange="pf_LinkPage();"
                  class="default_input_style input_margin_x_10px input_padding_y_4px search-control">
                  <option value="">전체</option>
                  <option value="0">전송 완료</option>
                  <option value="1">전송 준비</option>
                  <option value="2">전송 대기</option>
                  <option value="-1">전송 실패</option>
                </select>
                <div class="text-center mt-2">
                  <a>전송상태</a>
                </div>
          ...
          <tbody class="bg-white divide-y text-gray-700">
			...
			<c:forEach items="${resultList3 }" var="b">
	            <tr class="">
					...
					<td class="px-4 py-3 text-center"><a href="javascript:;" onclick="detailView('${b.dbl_keyno}'); focus_p();"><span class="text-sm">${b.dbl_p_name}</span></a></td>
