...
String fileName = "단체예약 신청자 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="6" class="title">단체예약 신청자 리스트</th>
		</tr>
		<tr></tr>
		<tr>
			<th colspan="6" class="Subdate" style="text-align:left;">
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">투어 일시</th>
			<th class="thsize">단체명</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName"><c:out value="${model.SEQ }"/></td>
			<td class="tdName"><c:out value="${model.GP_GROUPNAME }"/></td>
			<td class="tdName"><c:out value="${model.GP_REGDT }"/></td>
		</tr>
		</c:forEach>
	</tbody>
</table>
