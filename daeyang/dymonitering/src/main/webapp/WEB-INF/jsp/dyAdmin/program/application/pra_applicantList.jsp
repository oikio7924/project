				...
				<div class="widget-body">
					...
					<div class="table-responsive">
						<jsp:include page="/WEB-INF/jsp/dyAdmin/include/search/pra_search_header_paging.jsp" flush="true">
							<jsp:param value="/dyAdmin/program/application/applicationApply/pagingAjax.do" name="pagingDataUrl" />
							<jsp:param value="/dyAdmin/program/application/applicationApply/excelAjax.do" name="excelDataUrl" />
						</jsp:include>
...
function pf_detail(key, type){
	$("#key").val(key);
	if(type == 'U'){
		$("#Form").attr("action", "/dyAdmin/program/application/applicationApplyDetail.do");
	}else if(type == 'M'){
