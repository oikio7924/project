...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">활동기록 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">유저</th>
			<th class="thsize">홈페이지</th>
			<th class="thsize">활동 내역</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.HOMEDIV }</td>
			<td class="tdName">${model.AH_DESC }</td>
			<td class="tdName">${model.DATETIME }</td>
			<td class="tdName">${model.AH_IP }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
