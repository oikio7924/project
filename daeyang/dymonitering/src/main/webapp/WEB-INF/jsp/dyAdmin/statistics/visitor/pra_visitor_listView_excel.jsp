...
String fileName = "방문자 통계 접속자 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">방문자 통계 접속자 리스트</th>
		</tr>
		<tr></tr>
		<tr>
			...
			<th colspan="${colspan - 2}" class="Subdate">
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">접속경로</th>
			<th class="thsize">브라우저</th>
			<th class="thsize">운영체제</th>
			<th class="thsize">일시</th>
	...
	<tbody>
		...
		<tr>
			<td class="tdName">${model.IP }</td>
			<td class="tdName">${model.REFERER }</td>
			<td class="tdName">${model.BROWSER }</td>
			<td class="tdName">${model.OS }</td>
			<td class="tdName">${model.DAYTIME }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
