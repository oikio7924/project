...
String fileName = "페이지평가 코멘트 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title"> 코멘트 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">만족도</th>
			<th class="thsize">IP</th>
			<th class="thsize">코멘트</th>
			<th class="thsize">평가일</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.TPS_SCORE_NAME }</td>
			<td class="tdName">${model.TPS_IP }</td>
			<td style="text-align:left;" class="tdName"><pre><c:out value="${model.TPS_COMMENT }" escapeXml="false"/></pre></td>
			<td class="tdName">${model.TPS_REGDT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
