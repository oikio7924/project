...
<input type="hidden" name="dbp_subkey1" id="dbp_subkey1">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id="menu_1" style="width: 100%;">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id="menu_2" style="width: 100%; left:0px;" >
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0"
					...
					<div>
					<h1 style="float: left; margin-top: 0px; font-size: 15px" id="ssd">공급 받는자 구분</h1>
...
function loadBillInfo(){
	 ...
	 $.ajax({
        url: '/dyAdmin/bills/billsInfoInsert1.do',
        type: 'POST',
        data: $("#Form").serialize(),
        async: false,  
        success: function(result) {
