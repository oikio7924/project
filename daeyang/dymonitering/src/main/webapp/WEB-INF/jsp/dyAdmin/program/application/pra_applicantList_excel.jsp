...
String fileName = "프로그램 신청자 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="8" class="title">프로그램 신청자 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">날짜 / 시간</th>
			<th class="thsize">요금</th>
			<th class="thsize">신청일</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.DIVISION }</td>
			<td class="tdName">${model.AP_NAME }</td>
			<td class="tdName">${model.UI_NAME }</td>
			<td class="tdName">${model.SEQ }</td>
			<td class="tdName">${model.PRICE }</td>
			<td class="tdName">${model.APP_REGDT}</td>
			<td class="tdName">${model.STATUS }</td>
