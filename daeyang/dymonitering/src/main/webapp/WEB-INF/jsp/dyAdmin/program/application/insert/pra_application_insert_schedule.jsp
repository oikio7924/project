...
<div class="widget-body-toolbar bg-color-white" style="margin-bottom: 10px;">
	...
	<button style="float: right; margin: 10px 0;"  class="btn btn-sm btn-primary" type="button" onclick="pf_Addschedule();" >스케줄 추가</button>
	<div class="clear"></div>
</div>
...
<div id="scheduleInsert" title="스케줄 추가 ">
	<div class="widget-body scheduleInsert">
		<div class="table-responsive">
			<table class="table-bordered table-striped table-authorityInfo">
				<input type="hidden" id="resultKeyno">
				<tbody>
					<tr>
						<td style="vertical-align:middle; text-align:center;"><span class="nessSpan">*</span> 일시</td>
					...
					<tr>
						...
						<div class="row smart-form">
							...
							<label style="padding:0px 10px 0px 10px;">
 ...
 <%@ include file="pra_application_insert_schedule_script.jsp"%> 
