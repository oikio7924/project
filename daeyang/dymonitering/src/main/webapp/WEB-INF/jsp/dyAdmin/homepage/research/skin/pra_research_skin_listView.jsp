...
<div id="content">
	<form:form id="Form" name="Form" method="post" action="">
		<input type="hidden" name="PRS_KEYNO" id="PRS_KEYNO" value="" />
						...
						<div class="widget-body " >
							<div class="widget-body-toolbar bg-color-white">
								<div class="alert alert-info no-margin fade in">
									...
									페이지평가 스킨 목록입니다. 각 사이트별로 페이지 평가 스킨을  생성, 관리 할 수 있습니다.
								</div> 
							</div>
							<div class="widget-body-toolbar bg-color-white">
								<div class="row"> 
									<div class="col-sm-12 col-md-4 text-align-right" style="float:right;">
										...
										<div class="btn-group">  
											<button class="btn btn-sm btn-primary" type="button" onclick="pf_researchSkinRegist()">
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/dyAdmin/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/dyAdmin/homepage/research/pagingAjax.do" name="pagingDataUrl" />
...
//스킨관리 수정페이지 이동
function pf_researchSkinUpdate(key) {
	$("#PRS_KEYNO").val(key);
	$("#Form").attr("action", "/dyAdmin/homepage/research/updateView.do");
	$("#Form").submit();
} 

//스킨관리 등록페이지 이동 
function pf_researchSkinRegist() {
	$("#Form").attr("action", "/dyAdmin/homepage/research/insertView.do");
	$("#Form").submit();
}
...
function pf_PublishFile(key){
	...
	if(confirm(msg)) {
		...
		$.ajax({
		    type   : "post",
		    url    : "/dyAdmin/homepage/research/publishAjax.do",
		    data   : {"PRS_KEYNO" : key},
		    async  : false ,
