...
String fileName = "게시물 댓글 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">게시물 댓글 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">내용</th>
			<th class="thsize">작성자</th>
			<th class="thsize">작성일</th>
			<th class="thsize">좋아요</th>
			<th class="thsize">싫어요</th>
			<th class="thsize">삭제여부</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="tdName"><c:out value="${model.BC_CONTENTS }" escapeXml="true"/></td>
			<td class="tdName">${model.UI_NAME }</td>
			<td class="tdName">${model.BC_REGDT }</td>
			<td class="tdName">${model.BC_UP_CNT }</td>
			<td class="tdName">${model.BC_DOWN_CNT }</td>
			<td class="tdName">${model.BC_DEL }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
