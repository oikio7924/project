...
String fileName = "미사용 팝업 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">미사용 팝업 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	...
	<tbody>
		...
		<tr>
			<td class="tdName">${model.PI_MN_MAINNAME }</td>
			<td class="tdName">${model.PI_MN_NAME }</td>
			<td class="tdName">${model.PI_TITLE }</td>
			<td class="tdName">${model.PI_DATE }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
