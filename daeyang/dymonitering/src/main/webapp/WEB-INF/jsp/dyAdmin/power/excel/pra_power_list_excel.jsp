...
<%
	String fileName = "발전소 등록 리스트.xls";
...
<body>
	...
	<table>
		<thead>
			<tr></tr>
			<tr class="background">
				<th colspan="${colspan}" class="title">발전소 등록 리스트</th>
			</tr>
			<tr></tr>
			<tr>
	...
	<table id="dt_basic">
		<thead>
			<tr class="background2">
				...
				<th class="thsize">지역</th>
				<th class="thsize">발전소명</th>
				<th class="thsize">인버터갯수</th>
				<th class="thsize">등록일</th>
				<th class="thsize">x좌표</th>
				<th class="thsize">y좌표</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${resultList }" var="model" varStatus="status">
				<tr>
					...
					<td class="tdName">${model.DPP_AREA }</td>
					<td class="tdName">${model.DPP_NAME }</td>
					<td class="tdName">${model.DPP_INVER_COUNT }</td>
					<td class="tdName">${model.DPP_DATE }</td>
					<td class="tdName">${model.DPP_X_LOCATION }</td>
					<td class="tdName">${model.DPP_Y_LOCATION }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>