...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<tr>
			...
			<th class="hasinput">
				<select class="form-control search-control" data-searchindex="3" placeholder="홈페이지명 검색" onchange="pf_LinkPage()">
			...
			<th class="hasinput">
		        <input type="text" class="form-control search-control" data-searchindex="4" placeholder="메뉴명 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="5" placeholder="표출갯수 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="6" placeholder="작성자 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="7" placeholder="작성일 검색" />
			</th>
			<th class="hasinput">
			</th>
			<th class="hasinput">
		...
		<tr>
			...
			<th class="arrow" data-index="3">홈페이지명</th>
			<th class="arrow" data-index="4">메뉴명</th>
			<th class="arrow" data-index="5">표출 갯수</th>
			<th class="arrow" data-index="6">작성자</th>
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="javascript:pf_boardTypeUpdate('${model.BMM_KEYNO}')"><c:out value="${model.BMM_SUBJECT} "/></a></td>
			<td><c:out value="${model.BMM_HOME_NAME} "/></td>
			<td><c:out value="${model.BMM_MN_NAME} "/></td>
			<td><c:out value="${model.BMM_SIZE} "/></td>
			<td><c:out value="${model.BMM_UI_NAME} "/></td>
			<td><c:out value="${model.BMM_REGDT }"/></td>
			<td>
