...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">키워드 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">키워드</th>
			<th class="thsize">검색수</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.SK_KEYWORD }</td>
			<td class="tdName">${model.SK_SIZE }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
