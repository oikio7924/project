...
<body>
	...
	<table>
		<thead>
			<tr></tr>
			<tr class="background">
				<th colspan="${colspan}" class="title">사원 리스트</th>
			</tr>
			<tr></tr>
			<tr>
	...
	<table id="dt_basic">
		<thead>
			<tr class="background2">
				...
				<th class="thsize">사원명</th>
				<th class="thsize">부서</th>
				<th class="thsize">직책</th>
				<th class="thsize">업무명</th>
		...
		<tbody>
			<c:forEach items="${resultList }" var="model" varStatus="status">
				<tr>
					...
					<td class="tdName">${model.DU_NAME }</td>
					<td class="tdName">${model.DN_NAME }</td>
					<td class="tdName">${model.DU_ROLE }</td>
					<td class="tdName">${model.DU_CONTENTS }</td>
					<td class="tdName">${model.DU_TEL }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>