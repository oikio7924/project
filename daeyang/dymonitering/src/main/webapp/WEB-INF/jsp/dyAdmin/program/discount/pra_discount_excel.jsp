...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="6" class="title">할인정책 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">할인</th>
			<th class="thsize">설명</th>
			<th class="thsize">기본적용여부</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="tdName"><c:out value="${model.AD_NAME }"/></td>
			<td class="tdName">${model.AD_USE}</td>
			<td class="tdName"><c:out value="${model.MONEY }"/></td>
			<td class="tdName"><c:out value="${model.AD_COMENT }"/></td>
			<td class="tdName">${model.AD_DEFAULT_YN}</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
