...
function setPhotoToEditor(){
		...
		var tempImgs = '<figure>';
		if(link != ""){
			tempImgs += '<a href="'+link+'"><img id="tempimg'+imgnumber+'"  class="tempImgs" src="' + src + '" title="'+title+'" style="width:'+imgwidth+';height:'+imgheight+';"/></a>';
		}else{
			tempImgs += '<img id="tempimg'+imgnumber+'" class="tempImgs" src="' + src + '" title="'+title+'" style="width:'+imgwidth+';height:'+imgheight+';"/>'; 
		}
		tempImgs += '</figure>';
