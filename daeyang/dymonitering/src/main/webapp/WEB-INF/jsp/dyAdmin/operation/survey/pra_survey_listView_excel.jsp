...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">설문 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">시작일</th>
			<th class="thsize">종료일</th>
			<th class="thsize">참여인원</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.SM_TITLE }</td>
			<td class="tdName">${model.SM_REGNM }</td>
			<td class="tdName">${model.SM_STARTDT }</td>
			<td class="tdName">${model.SM_ENDDT }</td>
			<td class="tdName">${model.CNT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
