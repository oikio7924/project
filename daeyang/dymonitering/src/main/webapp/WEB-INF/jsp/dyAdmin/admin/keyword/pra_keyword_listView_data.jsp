...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<tr>
			...
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="2" placeholder="키워드 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="3" placeholder="검색수 검색" />
			</th>
			<th></th>
		</tr>
		<%-- 화살표 정렬 --%>
		<tr>
			<th class="arrow" data-index="1" style="width:10%;">번호</th>
			<th class="arrow" data-index="2" style="width:50%;">키워드</th>
			<th class="arrow" data-index="3" style="width:20%;">검색수</th>
	...
	<tbody>
		...
		<tr>
			...
			<td>${model.SK_SIZE }</td>
			<td>
				<button type="button" class="btn btn-info btn-sm btn-updateURL" onclick="pf_openKeywordList(this)">검색 회원 목록</button>
				<button type="button" class="btn btn-danger btn-sm" onclick="pf_deletekeyword(this)">삭제</button>
			</td>
		</tr>
		</c:forEach>
	</tbody>
