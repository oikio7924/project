...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<tr>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="1" placeholder="IP 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="2" placeholder="접속경로 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="3" placeholder="브라우저 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="4" placeholder="운영체제 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="5" placeholder="일시 검색" />
			</th>
		</tr>
		<%-- 화살표 정렬 --%>
		<tr>
			<th class="arrow" data-index="1">IP</th>
			<th class="arrow" data-index="2" style="width:50%;">접속경로</th>
			<th class="arrow" data-index="3">브라우저</th>
			<th class="arrow" data-index="4">운영체제</th>
			<th class="arrow" data-index="5">일시</th>
		</tr>
	</thead>
	<tbody>
		<c:if test="${empty resultList }">
