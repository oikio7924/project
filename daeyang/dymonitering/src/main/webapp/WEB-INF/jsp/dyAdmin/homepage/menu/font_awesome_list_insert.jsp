...
#menuIconView_insert {font-size:50px; margin:15px 5px;} 
...
$(function(){
	...
	$('#menuIconBox .demo-icon-font').on('click', function(){
...
// 	  alert($(this).children('i').attr('class'));
	  ...
	  $('#menuIconView').attr('class','').addClass(classNm);
	  $('#Mainmenu-ICONBOX').val(classNm);
