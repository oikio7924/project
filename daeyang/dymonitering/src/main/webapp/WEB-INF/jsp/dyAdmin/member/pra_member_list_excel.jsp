...
<body>
	...
	<table>
		<thead>
			<tr></tr>
			<tr class="background">
				<th colspan="${colspan}" class="title">회원 리스트</th>
			</tr>
			<tr></tr>
			<tr>
	...
	<table id="dt_basic">
		<thead>
			<tr class="background2">
				...
				<th class="thsize">권한</th>
				<th class="thsize">이메일</th>
				<th class="thsize">전화번호</th>
				<th class="thsize">가입날짜</th>
				<th class="thsize">마지막 로그인</th>
				<th class="thsize">인증여부</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${resultList }" var="model" varStatus="status">
				<tr>
					...
					<td class="tdName">${model.UI_ID }</td>
					<td class="tdName">${model.UI_NAME }</td>
					<td class="tdName">${model.UIA_NAME }</td>
					<td class="tdName">${model.UI_EMAIL }</td>
					<td class="tdName">${model.UI_PHONE }</td>
					<td class="tdName">${model.UI_REGDT }</td>
					<td class="tdName">${model.UI_LASTLOGIN }</td>
					<td class="tdName">${model.AUTH }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>