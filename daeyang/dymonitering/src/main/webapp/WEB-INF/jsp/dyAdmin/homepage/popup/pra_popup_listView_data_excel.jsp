...
String fileName = "사용중인 팝업 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">사용중인 팝업 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">기간</th>
			<th class="thsize">링크</th>
	...
	<tbody>
		...
		<tr>
			<td class="tdName">${model.PI_TITLE}</td>
			<td class="tdName">${model.PI_STARTDAY }~${model.PI_ENDDAY }</td>
			<td class="tdName">${model.PI_LINK }</td>
			<td class="tdName">${model.PI_TYPE_TEXT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
