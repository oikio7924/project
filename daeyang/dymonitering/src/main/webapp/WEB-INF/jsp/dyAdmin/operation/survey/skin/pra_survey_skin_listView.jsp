                        ...
                        <div class="widget-body ">
                            ...
                            <div class="table-responsive">
                                <jsp:include page="/WEB-INF/jsp/dyAdmin/include/search/pra_search_header_paging.jsp" flush="true">
                                    <jsp:param value="/dyAdmin/operation/survey/skinPagingAjax.do" name="pagingDataUrl" />
                                </jsp:include>
...
<script type="text/javascript">
    ...
    function pf_SkinUpdate(key) {
        $("#SS_KEYNO").val(key);
        $("#Form").attr("action", "/dyAdmin/operation/survey/skinUpdate.do");
        $("#Form").submit();
    }
    ...
    function pf_Distribute(allck, key) {
        ...
        if (confirm(msg)) {
            ...
            $.ajax({
                type: "post",
                url: "/dyAdmin/operation/survey/distributeAjax.do",
                data: {
                    "allck": allck,
                    "SS_KEYNO": key
                },
