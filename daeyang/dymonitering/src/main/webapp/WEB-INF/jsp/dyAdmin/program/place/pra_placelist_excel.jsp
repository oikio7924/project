...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="6" class="title">장소관리 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">좌석수</th>
			<th class="thsize">사용여부</th>
			<th class="thsize">좌석배치도</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${resultList }" var="model" varStatus="status">
		<tr>
			<td class="tdName"><c:out value="${model.COUNT }"/></td>
			<td class="tdName"><c:out value="${model.PM_NAME }"/></td>
			<td class="tdName"><c:out value="${model.PM_NAME_EN }"/></td>
			<td class="tdName"><c:out value="${model.PM_SEAT }"/></td>
			<td class="tdName"><c:out value="${model.PM_USE }"/></td>
			<td class="tdName"><c:out value="${model.PM_SEATPLAN_YN }"/></td>
		</tr>
		</c:forEach>
	</tbody>
</table>
