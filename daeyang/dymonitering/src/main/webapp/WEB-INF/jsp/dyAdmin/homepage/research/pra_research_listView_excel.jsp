...
String fileName = "페이지 평가 결과 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">페이지 평가 결과 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">페이지</th>
			<th class="thsize">총인원수</th>
			<th class="thsize">매우 만족</th>
			<th class="thsize">만족</th>
			<th class="thsize">보통</th>
			<th class="thsize">불만족</th>
			<th class="thsize">매우 불만족</th>
			<th class="thsize">결과</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.TOTAL_CNT }</td>
			<td class="tdName">${model.SCORE_DATA5 }</td>
			<td class="tdName">${model.SCORE_DATA4 }</td>
			<td class="tdName">${model.SCORE_DATA3 }</td>
			<td class="tdName">${model.SCORE_DATA2 }</td>
			<td class="tdName">${model.SCORE_DATA1 }</td>
			<td class="tdName">${model.RESULT_DATA }</td>
