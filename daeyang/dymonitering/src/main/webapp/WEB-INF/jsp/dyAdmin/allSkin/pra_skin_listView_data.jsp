...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<%-- 화살표 정렬 --%>
		<tr>
			<th class="arrow" data-index="1">메뉴 이름</th>
			<th class="arrow">바로가기</th>
		</tr>
	</thead>
	<tbody>
		<c:if test="${empty resultList }">
		...
		<tr>
			...
			<td><button type="button" class="btn btn-default" onclick="location.href='${model.MN_URL}'">바로가기</button></td>
		</tr>
		</c:forEach>
	</tbody>
</table>
