...
<aside class="z-30 flex-shrink-0 w-64 overflow-y-auto bg-white block hidden lg:block">
  <div class="py-4 text-gray-500">
    <span class="flex ml-6 text-base md:text-base lg:text-lg md:text-base font-bold text-gray-800">사업개발부 일정관리</span>
	  <ul class="mt-6 px-6">
			<li class="relative py-3">
		      ...
		      href="/bd/main.do">
		        <img src="/resources/img/icon/checking.svg" class="fill-red w-5 h-5" alt="">
		        <span class="ml-4">캘린더</span>
		      </a>
		    </li>
		    <li class="relative py-3">
		      <a class="text-black bg-button-gray py-3.5 px-3 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 rounded-lg" 
		      href="/bd/license/registration.do">
		        <img src="/resources/img/icon/shieldKeyholeFillBlack.svg" class="fill-red w-5 h-5" alt="">
		        <span class="ml-4">인허가 일정 등록</span>
		      </a>
		    </li>
		    <li class="relative py-3">
		      <a class="text-black bg-button-gray py-3.5 px-3 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 rounded-lg" 
		      href="/bd/license/situation.do">
		        <img src="/resources/img/icon/shieldKeyholeFillBlack.svg" class="fill-red w-5 h-5" alt="">
		        <span class="ml-4">인허가 진행 현황</span>
		      </a>
		    </li>
