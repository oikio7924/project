            ...
            <sec:authorize url="${model.MN_URL}">
                ...
                <li>
                    ...
                    <sec:authorize url="${model2.MN_URL}">
                        <li>
                            <a href="javascript:;" onclick="pf_moveMenu('${model2.MN_REAL_URL}','${model2.MN_PAGEDIV_C }','${model2.MN_NEWLINK}')" title="${model2.MN_NAME }">${model2.MN_NAME }</a>
                            ...
                            <div class="subMoreBtn">
                                ...
                                <sec:authorize url="${model3.MN_URL}">
                                    <li><a href="javascript:;" onclick="pf_moveMenu('${model3.MN_REAL_URL}','${model3.MN_PAGEDIV_C }','${model3.MN_NEWLINK}')" title="${model3.MN_NAME }">${model3.MN_NAME }</a></li>
                                </sec:authorize>
                                </c:if>
                                </c:forEach>
                                </ul>
