	...
	this.enqueueFile = function(file){
        ...
        this.createProgress = function (filename,filepath,filesize) {
            ...
            if(s.showFileCounter)
            	fileNameStr = '<font class="fileCounter">' + obj.fileCounter + s.fileCounterStyle + '</font>' + filename;
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
                ...
                var fileNameStr = "";
                if(s.showFileCounter) 
                	fileNameStr = '<font class="fileCounter">' + obj.fileCounter + s.fileCounterStyle + '</font>' + files[i].name;
                else 
