 ...
 */
! function(e) {
    void 0 == e.fn.ajaxForm && e.getScript("/resources/api/uploadfile/jquery.form.js");
    var a = {};
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        function h(t, r, o, s) {
            var i = "ajax-upload-id-" + (new Date).getTime(),
                ...
                p = "<input type='file' id='" + i + "' name='" + o.fileName + "' accept='" + o.acceptFiles + "' title='첨부파일 업로드'/>";
            o.multiple && (o.fileName.indexOf("[]") != o.fileName.length - 2 && (o.fileName += "[]"), p = "<input type='file' id='" + i + "' name='" + o.fileName + "' accept='" + o.acceptFiles + "' multiple  title='첨부파일 업로드'/>");
        ...
        var w = e.extend({
            ...
            sequentialCount: 2,
            customProgressBar: !1,
            abortButtonClass: "ajax-file-upload-중지",
            cancelButtonClass: "ajax-file-upload-취소",
            dragDropContainerClass: "ajax-upload-dragdrop",
            dragDropHoverClass: "state-hover",
            errorClass: "ajax-file-upload-에러",
            uploadButtonClass: "ajax-file-upload",
            dragDropStr: "<span><b>Drag &amp; Drop 파일</b></span>",
            uploadStr: "업로드",
            abortStr: "중지",
            cancelStr: "취소",
            deletelStr: "삭제",
            doneStr: "완료",
            multiDragErrorStr: "여러 파일의 Drag &amp; Drop 이 허용되지 않습니다.",
            extErrorStr: "업로드 할수 없습니다. 허용된 확장자: ",
            duplicateErrorStr: "업로드 할 수 없습니다. 파일이 이미 존재합니다.",
            sizeErrorStr: "파일은 업로드 할 수 없습니다. 파일 최대 사이즈: ",
            uploadErrorStr: "업로드 할 수 없습니다.",
            maxFileCountErrorStr: "파일은 업로드 할 수 없습니다. 최대 파일 개수:",
            downloadStr: "다운로드",
            customErrorKeyStr: "jquery-upload-파일-에러",
            showQueueDiv: !1,
            statusBarWidth: 400,
            dragdropWidth: 400,
            showPreview: !1,
