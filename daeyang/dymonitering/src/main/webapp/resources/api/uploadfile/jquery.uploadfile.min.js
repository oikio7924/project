        ...
        function v(t, o, s, l, n, d) {
        	var h = {
                ...
                error: function(e, a, r) {
                	...
                	$(s.statusbar).find(".ajax-file-upload-del").show();
                	$(s.statusbar).find(".ajax-file-upload-del").attr("id","del"+delcnt);
                	$(s.statusbar).find(".ajax-file-upload-del").attr("onClick","pf_errorFileDel(\'"+"del"+delcnt+"\')");
                }
            };
