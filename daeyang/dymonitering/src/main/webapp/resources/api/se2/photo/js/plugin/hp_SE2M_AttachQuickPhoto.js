...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		if(oNavigator.mobile || oNavigator.msafari){ // 모바일
			
		}else{ // PC
			this.htPopupOption.sProperties = "left=0,top=0,width=403,height=389,scrollbars=yes,location=no,status=0,resizable=no";
		}
