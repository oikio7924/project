...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        emptyClass: 'dd-empty2',
        expandBtnHTML: '<button class="dd-expand" data-action="expand" type="button" style="display:none;">Expand</button>',
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            var onStartEvent = function(e) {
                ...
                if (handle.parent().hasClass(list.options.noDragClass)) {
            		return;
                }
