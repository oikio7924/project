...
//                    !this instanceof TableTools && alert("Warning: TableTools must be initialised with the keyword 'new'");
                    !this instanceof TableTools && alert("Warning: 테이블 툴은 'new'키워드로 초기화해야합니다.");
                    ...
                    "copy": a.extend({}, TableTools.buttonBase, {
                        ...
                        "fnComplete": function(a, b, c, d) {
                            ...
                            var f = 1 == e ? "" : "s";
                            this.fnInfo("<br><h5>테이블이 복사되었습니다.</h5><p>Copied " + e + " row" + f + " to the clipboard.</p>", 1500)
                        }
                    }),
                    ...
                    "print": a.extend({}, TableTools.buttonBase, {
                        "sInfo": "<h5>Print view</h5><p>당신의 브라우저의 인쇄기능을 이용하여<br>테이블을 복사하세요.<br>ESC를 누르면 종료됩니다.</p>",
                        "sMessage": null,
                        "bShowAll": !0,
...
//                                    alert("Error detected when sending table data to server")
                                    alert("Error: 서버에 테이블 데이터를 보낼 때 오류가 감지되었습니다.")
                                }
                            })
                        },
...
//                    "sSwfPath": "../swf/copy_csv_xls_pdf.swf",
                    "sSwfPath" : "/resources/smartadmin/js/plugin/datatables/swf/copy_csv_xls_pdf.swf",
                    "sRowSelect": "none",
                    "sRowSelector": "tr",
                    "sSelectedClass": null,
                    "fnPreRowSelect": null,
