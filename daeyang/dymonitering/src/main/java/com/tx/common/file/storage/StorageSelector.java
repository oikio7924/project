//package com.tx.common.file.storage;
//
...
//import com.tx.common.file.storage.local.LocalFileService;
...
//		}else if("none".equals(STORAGE)){
//			
//			LocalFileService.delete(fileSub);
//		}
//	}
//	
//
...
//			try {
//				mimeType = StorageSelector.getFileMimeType(file);
//			} catch (Exception e) {
//				System.out.println("mimeType 에러");
//			}
//		}
...
//		if("tronix".equals(STORAGE)){
//			
//			TronixStorageService.getImgPath(boardNoticeDataList, "THUMBNAIL_PUBLIC_PATH", "THUMBNAIL_PATH");
//			
//		}else if("none".equals(STORAGE)){
//
//			LocalFileService.getImgPath(boardNoticeDataList, "THUMBNAIL_PATH", "THUMBNAIL_PATH");
//		}
//	}
//	
//	/**
...
//		if("tronix".equals(STORAGE)){
//			TronixStorageService.getImgPath(boardNoticeDataList, requestName, responseName);
//			
//		}else if("none".equals(STORAGE)){
//			
//			LocalFileService.getImgPath(boardNoticeDataList, requestName, responseName);
//		}
//	}
//
//
