...
@Service("TronixStorageService")
public class TronixStorageServiceImpl extends EgovAbstractServiceImpl implements TronixStorageService{
	...
	public TronixStorageServiceImpl(){
	...
	public void getImgPathByFileSub(List<FileSub> FileSub){
		...
		for(FileSub file : FileSub){

			file.setFS_PATH(getImgPathString((String)file.getFS_PUBLIC_PATH()));
...
//		String thumbnail = "";
		...
		if( IsImageFile.isImageFile(newFile) ){
...
//			}
		...
		}else if (IsImageFile.isVideoFile(newFile)){
