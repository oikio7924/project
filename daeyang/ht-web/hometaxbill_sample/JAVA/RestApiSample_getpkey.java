...
public class RestApiSample_getpkey {
	...
	public static void main(String[] args) throws Exception {
		...
		String restapi = "";
		// 전자세금계산서 발행 후 리턴
		restapi = Api("http://115.68.1.5:8084/homtax/getpkey", data.toString());
		//restapi = Api("http://115.68.1.5:8084/homtax/getpkeyAll", data.toString()); //세금계산서 전체항목 RETURN시 사용
		
		// Api함수의 리턴값이 fail이면 서버에 문제있음
		...
		System.out.println("code : "+jsonObj.get("code"));							//결과코드
		System.out.println("msg : "+jsonObj.get("msg"));							//결과메세지
		System.out.println("hometaxbill_id : "+jsonObj.get("hometaxbill_id"));		//회사코드
		System.out.println("homemunseo_id : "+jsonObj.get("homemunseo_id"));		//업체고유번호
		System.out.println("issueid : "+jsonObj.get("issueid"));					//승인번호
		System.out.println("declarestatus : "+jsonObj.get("declarestatus"));		//세금계산서 발행상태
		System.out.println("msg2 : "+jsonObj.get("msg2"));							//세금계산서 발행상태 내용
