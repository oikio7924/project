...
const props = defineProps({
  ...
  priceReadonly: { type: Boolean, default: false }
});
    ...
    <table>
      ...
      <tbody>
        <tr v-for="(row, index) in rows" :key="index">
          ...
          <td>
            <strong v-if="priceReadonly" class="readonly-price">{{ money(row.unit_price) }}원</strong>
            <PriceInput v-else v-model="row.unit_price" />
          </td>
